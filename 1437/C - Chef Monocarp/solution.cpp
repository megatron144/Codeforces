...
void test_cases(){
    ...
    //     int len=j-i;
    //     i=j-1;
    //     int b1=val-len/2,b2=b1-(len&1)+1;
    //     int inc=0;
    //     //cout<<t<<" ";
    //     if(len&1)inc=(len/2)*(len/2+1);
    //     else inc=((len-1)/2)*((len-1)/2+1)+len/2;
    //     if(t<=b1)cost+=inc,t=b1+len;
    //     else if(t<=b2)cost+=inc,t=b2+len;
    //     else{
    //         int rounds=t-b2;
    //         int add=2-(len&1);
    //         while(rounds--){
